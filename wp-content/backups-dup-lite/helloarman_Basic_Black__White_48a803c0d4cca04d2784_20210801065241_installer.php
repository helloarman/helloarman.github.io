...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'helloarman_Basic_Black__White_48a803c0d4cca04d2784_20210801065241_archive.zip';
	const ARCHIVE_SIZE		 = '66972127';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '48a803c-01065241';
    const SECONDARY_PACKAGE_HASH = 'f21006f-01065241';
	const VERSION			 = '1.4.2';
